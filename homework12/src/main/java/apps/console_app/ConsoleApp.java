...
public class ConsoleApp {
    ...
    private static void prettyFamilyDisplayer(List<Family> objects) {
        //used to display families by indexation, starting with 1
        IntStream.rangeClosed(1, objects.size())
                .forEach(i -> System.out.printf("Family %d:\n%s\n\n", i, objects.get(--i).prettyFormat()));
    }
}