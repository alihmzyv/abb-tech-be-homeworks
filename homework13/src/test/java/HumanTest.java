...
public class HumanTest {
    ...
    void toStringShouldReturnCorrectData() {
        ...
        String expected = String.format("Human{name=%s, surname=%s, birthdate=%s, iq=%d, schedule=%s}",
                ...
                father1.getBirthDate().format(DateTimeFormatter.ofPattern("d/M/yyyy")),
                father1.getIq(),
    ...
    void equalsWorksAccordingToContract() {
        ...
        Human human1 = new Human("Mammad", "Karimov", "21/09/1978", 100, Map.of(DayOfWeek.MONDAY, List.of("go to work")));
        ...
        Human human2 = new Human("Mammad", "Karimov", "21/09/1978", 100, Map.of(DayOfWeek.MONDAY, List.of("go to work")));
        ...
        Human human3 = new Human("Mammad", "Karimov", "21/09/1978", 100, Map.of(DayOfWeek.MONDAY, List.of("go to work")));
    ...
    @Test
    void getBirthDateTest1() {
        Human human = new Human("Ali", "Hamzayev", "24/03/2001", 100);
        assertEquals(LocalDate.of(2001, 03, 24), human.getBirthDate());
    }

    @Test
    void describeAgeTest1() {
        Period period = Period.between(LocalDate.of(2001, 03, 24), LocalDate.now());
        String expected = String.format("Years: %d, Months: %d, Days: %d", period.getYears(), period.getMonths(),
                period.getDays());
        assertEquals(expected, new Human("Ali", "Hamzayev", "24/03/2001", 100).describeAge());
    }
}