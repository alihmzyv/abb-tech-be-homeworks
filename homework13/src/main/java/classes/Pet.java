...
public abstract class Pet implements Serializable {
    @Serial
    private static final long serialVersionUID = -4884154779992913939L;
    ...
    public String prettyFormat() {
        return String.format("{species = %s, nickname=%s: Can fly: %s, Has %d legs, Has fur: %s; age=%d, tricklevel=%d, habits=%s}",
                species, nickname, species.canFly, species.numberOfLegs, species.hasFur, age, trickLevel, habits);
