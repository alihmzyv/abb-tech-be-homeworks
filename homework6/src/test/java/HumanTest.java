...
class HumanTest {
    ...
    void equalsWorksAccordingToContract() {
        ...
        Human human1 = new Human("Mammad", "Karimov", 1976, 100, new String[][]{{DayOfWeek.MONDAY.name(), "go to work"}});
        ...
        Human human2 = new Human("Mammad", "Karimov", 1976, 100, new String[][]{{DayOfWeek.MONDAY.name(), "go to work"}});
        ...
        Human human3 = new Human("Mammad", "Karimov", 1976, 100, new String[][]{{DayOfWeek.MONDAY.name(), "go to work"}});
